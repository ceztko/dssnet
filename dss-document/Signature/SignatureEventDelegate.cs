...
{
	/// <summary>Utility class for module working with SignatureEventListeners.</summary>
	/// <remarks>Utility class for module working with SignatureEventListeners.</remarks>
	...
	public class SignatureEventDelegate
	{
		...
		/// <summary>Remove an existing listener</summary>
		/// <param name="listener"></param>
		...
		/// <summary>Send the event to all the listeners</summary>
		/// <param name="event"></param>
		public virtual void FireEvent(SignatureEvent @event)
		{
			lock (this)
			{
				foreach (SignatureEventListener l in listeners)
				{
					l.Event(@event);
				}
			}
