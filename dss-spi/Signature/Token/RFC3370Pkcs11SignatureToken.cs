...
//jbonilla No se implementa Pkcs11
...
//    /// 	</version>
//    public class RFC3370Pkcs11SignatureToken : AsyncSignatureTokenConnection
//    {
...
//        public RFC3370Pkcs11SignatureToken(string pkcs11Path) : this(pkcs11Path, (PasswordInputCallback
//            )null)
//        {
//        }
...
//        public RFC3370Pkcs11SignatureToken(string pkcs11Path, char[] password) : this(pkcs11Path
...
//                try
//                {
//                    _keyStore.Load(new _LoadStoreParameter_122(this));
//                }
//                catch (Exception e)
//                {
...
//        private sealed class _LoadStoreParameter_122 : KeyStore.LoadStoreParameter
//        {
//            public _LoadStoreParameter_122(RFC3370Pkcs11SignatureToken _enclosing)
//            {
...
//            {
//                return new KeyStore.CallbackHandlerProtection(new _CallbackHandler_126(this));
//            }

//            private sealed class _CallbackHandler_126 : CallbackHandler
//            {
//                public _CallbackHandler_126(_LoadStoreParameter_122 _enclosing)
//                {
//                    this._enclosing = _enclosing;
//                }
...
//                private readonly _LoadStoreParameter_122 _enclosing;
//            }

//            private readonly RFC3370Pkcs11SignatureToken _enclosing;
//        }
